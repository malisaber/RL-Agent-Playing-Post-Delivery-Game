classdef PostDeliveryDqnEnv < handle
	properties
		Pack_poses;
		Dest_poses;
		Action_length;
	...
	methods
		% Constructor
		function obj = PostDeliveryDqnEnv(Pack_poses, Dest_poses, Walls, gamma)
		...
		function [ns, nr, done] = Dynamics(obj, action)
			...
			switch action
				case 1
					[ny, wrong] = clip_to_bounds(obj.car_pos.y-1, 0, 4);
				case 2
					[nx, wrong] = clip_to_bounds(obj.car_pos.x+1, 0, 4);
				case 3
					[ny, wrong] = clip_to_bounds(obj.car_pos.y+1, 0, 4);
				case 4
					[nx, wrong] = clip_to_bounds(obj.car_pos.x-1, 0, 4);
